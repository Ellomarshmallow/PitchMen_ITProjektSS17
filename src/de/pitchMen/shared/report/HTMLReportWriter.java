...
public class HTMLReportWriter extends ReportWriter {
	...
	public void process(AllApplicationsOfUser a) {
		...
		//./p f�r einen Abstand und Tabelle �ffnen. Zuerst eine Row �ffnen um anschlie�end der Row Columns hinzuzuf�gen. 
		buff.append("<p><table border=1px rules=all> <tr>");
		
		//Fixe Werte den Columns zuweisen. Absprache mit Gruppe nochmal n�tig --> LL
