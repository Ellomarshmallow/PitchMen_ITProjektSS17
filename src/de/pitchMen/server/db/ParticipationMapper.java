...
public class ParticipationMapper {
		 ...
		 * Aufgerufen wird die Klasse somit über ParticipationMapper.participationMapper() und
		...
		/**
		 * Findet ein Participation-Objekt anhand der übergebenen ID in der Datenbank.
		 * 
		 * @param id 
		 * @return person
		 */
