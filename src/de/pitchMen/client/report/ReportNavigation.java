	...
	public void onLoad() {
		...
		report5Btn.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				applicantBox.addItem("Bitte w‰hle einen Bewerber aus");
				...
				public void onChange(ChangeEvent event){
					...
					int ausgew‰hltId = Integer.valueOf(last);
					
					
					repGenA.showProjectInterweavingsWithParticipationsAndApplications(ausgew‰hltId,
