...
public class ShowProjects extends BasicContent {
	...
	protected void run() {
		...
		/*
		 * FIXME Fehlende Methode getProject() in PitchMenAdmin
		 * 
		 * Die Methode getProject() ist in der PitchMenAdmin-Klasse
		 * nicht implementiert. Sollte sie aber eigentlich sein. Oder?
		 * 
		 * Außerdem: Müsste die Methode dann nicht getProjects() heißen?
		 * 
		 * Simon, 26.05.2017, 14:00
		 */
